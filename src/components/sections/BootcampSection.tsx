...
export default function BootcampSection() {
  ...
  const section: Section | undefined = sections?.[2];
      ...
      <div className="flex justify-between border-b border-[#E5E7EB] mb-4">
        <div className="flex">
          <button
            ...
            className={`md:px-4 py-2 cursor-pointer border-b-2 border-transparent transition-colors duration-200 text-md font-medium text-xs md:text-md lg:text-lg  ${
              activeTab === "Terbaru"

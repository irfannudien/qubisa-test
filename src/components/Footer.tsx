...
export default function Footer() {
  return (
    <footer className="bg-gray-50 py-12 px-10 overflow-hidden">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-10">
        <div className="mb-12">
          ...
          <div className="flex space-x-3">
            ...
            <Link
              href="#"
              className="w-10 h-10 bg-blue-400 rounded-full flex items-center justify-center hover:opacity-80 transition-opacity"
            >
              <svg
                className="w-5 h-5 text-white"
                fill="currentColor"
        ...
        <div className="w-full px-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
          <div>
          ...
          <div>
            <h3 className="font-semibold text-gray-900 mb-4">Kelas</h3>
            <ul className="space-y-3">
              <li>
                <Link
                  href="#"
